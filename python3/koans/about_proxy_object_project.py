...
class Proxy:
    ...
    # getattr method that forwards to the target _obj
    def __getattr__(self, attr_name):
        self._messages.append(attr_name)
        return getattr(self._obj, attr_name)

    # Set attributes on the target object insted of the proxy.
    def __setattr__(self, attr_name, value):

        # Only set the attribute on the target object if _obj is defined.
    ...
    # Messsages method returns messages list
    def messages(self):
        return self._messages

    # Return boolean indicating if an attribute was called.
    def was_called(self, attr_name):
        return attr_name in self._messages

    #Return number of times a specific attribute was called.
